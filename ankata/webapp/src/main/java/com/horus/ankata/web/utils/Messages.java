...
public class Messages {
    ...
    public static String getString(String key,String _value) {
        Object[] messageArguments = { getString(_value) };
        return getString(key,messageArguments);
    }
    
    public static String getString(String key,String _value1,String _value2) {
        Object[] messageArguments = { getString(_value1),getString(_value2) };
        return getString(key,messageArguments);
    }
    ...
    public static String getString(String key) {
        ...
        formatter.applyPattern(messages.getString(key));
        String output = formatter.format(null);
        return output;
    }
